...
Note: Infeasible paths were removed from the calculation as per the notes. This includes any pairs that have node 5,
because this statement can never be reached due to the nature of the if statement in node 4 and 'total' declaration in
node 3. All other paths can technically be tested for this method.
