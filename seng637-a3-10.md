...
| -------------------------------------------------- | ------------------------------------------------ | 
|calculateColumnTotalThreeArgsForAllRows()||
...
|calculateColumnTotalThreeArgsRowOneLBValue()||
...
| Test Case                                | DU-pairs covered                                                                                                                           
| -------------------------------------------------- | ------------------------------------------------ | 
|testExpandToInclude_nullRange()||
|testExpandToInclude_valueBelowRange()||
|testExpandToInclude_valueAboveRange()||
|testExpandToInclude_valueWithinRange()||
|testExpandToInclude_valueAtLowerBound()||
|testExpandToInclude_valueAtUpperBound()||
|testExpandToInclude_NaNValue()||
